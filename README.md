# Collection of Useful Scripts for Windows 11
...
- **Shutdown Script**: Scripts that runs when the system is shut down to clean up temporary files, shut down applications safely, and ensure the system is ready for shutdown.

**Manual Execution** contains scripts that are intended to be run manually according to your specific needs.
